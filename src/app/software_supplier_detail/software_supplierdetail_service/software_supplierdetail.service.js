...
var Software_SupplierDetail_Service = (function () {
    function Software_SupplierDetail_Service(router, http, toastr, activateroute) {
        this.router = router;
        this.http = http;
        this.toastr = toastr;
    ...
    // }
    //GET ITEM UNIT
    Software_SupplierDetail_Service.prototype.getSupplierList = function (Id) {
        var supplierObservableArray = new wijmo.collections.ObservableArray();
        var url = "http://localhost:2558/api/supplier/list/" + Id;
    ...
    // update ITEM
    Software_SupplierDetail_Service.prototype.putSupplierData = function (id, supplierObject, toastr) {
        var _this = this;
        var url = "http://localhost:2558/api/supplier/put/" + id;
        this.http.put(url, JSON.stringify(supplierObject), this.options).subscribe(function (response) {
            _this.toastr.success('', 'Successful');
            setTimeout(function () {
                _this.router.navigate(['/supplier']);
            }, 1000);
        }, function (error) {
            alert("Error");
        });
    };
    return Software_SupplierDetail_Service;
}());
Software_SupplierDetail_Service = __decorate([
    core_1.Injectable(),
...
exports.Software_SupplierDetail_Service = Software_SupplierDetail_Service;
//# sourceMappingURL=software_supplierdetail.service.js.map